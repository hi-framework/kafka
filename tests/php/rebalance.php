...
function fmtEvent(array $e): string
{
    ...
    $parts = \array_map(static fn ($p) => "{$p['topic']}:{$p['partition']}", $e['partitions']);
    return \mb_strtoupper($e['type']) . ' ' . \implode(',', $parts);
}
...
$assignA1 = \array_filter($eventsA1, static fn ($e) => 'assign' === $e['type']);
if (0 === \count($assignA1)) {
...
$revokeA2 = \array_filter($eventsA2, static fn ($e) => 'revoke' === $e['type']);
$assignA2 = \array_filter($eventsA2, static fn ($e) => 'assign' === $e['type']);
...
$assignA3 = \array_filter($eventsA3, static fn ($e) => 'assign' === $e['type']);
if (0 === \count($assignA3)) {
